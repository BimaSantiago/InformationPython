                ...
                content: {
                    ...
                    body: (
                        <DivContent>
                            ...
                            <h1>Configuración de VS Code</h1>
                            <p>
...
altura = 1.78`}
                            ...
                            <Code>
                                {`nombre = 'Kevin'
mensaje = 'Kevin, feliz cumpleaños!!'
...
8 << 1  # 1000 << 1 = 10000 = 16 (Multiplica por 2)`}</Code>
                            ...
                            <h3>Jerarquía de prioridades</h3>
                            <p>
                            ...
                            <h3>Operadores booleanos y máscaras de bits </h3>
                            <p>
...
permisos = permisos | 0b010  # 0b101 | 0b010 = 0b111 = 7`}
                            ...
                            <h3>Desplazamiento binario (Multiplicación/División rápida)</h3>
                            <ul className="list-disc list-inside ml-4">
                ...
                content: {
                    ...
                    body: (
                        <DivContent>
                            ...
                            <h3>Comprensión de listas: sintaxis y ejemplos </h3>
                            <p>
...
print(etiquetas) # ['impar', 'par', 'impar', 'par', 'impar']`}
                            ...
                            <h3>Listas anidadas y matrices (listas bidimensionales y más)</h3>
                            <p>
...
#  [0, 0, 0, 1]]`}
                            ...
                            <h3>Arreglos multidimensionales (3D, 4D, hasta nD)</h3>
                            <p>
...

{
    ...
    # instrucciones anidadas`}
                            ...
                            <ul className="list-disc list-inside ml-4">
                                <li>Siempre comienza con la palabra reservada \`def\` (de defnir).</li>
